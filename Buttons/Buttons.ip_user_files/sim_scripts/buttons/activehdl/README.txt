...
#
# Generated by export_simulation on Fri Mar 15 11:00:49 +0300 2024
#
################################################################################
...
'-reset_run' switch to the './buttons.sh' script.

./buttons.sh -reset_run
...
./buttons.sh -noclean_files

For more information on the script, please type './buttons.sh -help'.
